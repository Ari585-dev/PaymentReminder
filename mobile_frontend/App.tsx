  ...
  return (
    <View style={tailwind`flex-1 items-center justify-center bg-slate-50`}>
      ...
      <Image style={{ paddingLeft:320, width: 340, height: 340}} source={require('./img/udistritallogo.png')} />
        ...
        <TextInput style={tailwind`w-full bg-white border border-slate-200 rounded-md h-12 px-4 mb-4`}
          placeholderTextColor="#000"
          placeholder="Ingresa codigo de estudiante"
        />

        <TextInput style={tailwind`w-full bg-white border border-slate-200 rounded-md h-12 px-4`}
          placeholderTextColor="#000"
        ...
        <Pressable style={tailwind`h-13 bg-blue-500 rounded-md flex flex-row justify-center items-center px-6`}
          onPress={()=>login()}
        >
